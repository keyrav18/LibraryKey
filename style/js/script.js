...
document.addEventListener("DOMContentLoaded", function() {
    var button = document.getElementById("colorButton"); // Mendapatkan elemen tombol berdasarkan ID

    button.addEventListener("click", function() { // Menambahkan pendengar acara klik ke tombol
        button.classList.toggle("pink"); // Mengubah kelas tombol menjadi 'pink' saat diklik
    });
});
