  ...
  <body style="background-color: antiquewhite">
     <nav class="navbar fixed-top bg-body-tertiary shadow-sm">
      <div class="container-fluid p-3">
        ...
        <ul style="margin-left: -7rem;" class="dropdown-menu position-absolute mt-2 p-2">
          ...
          <li>
            <a class="dropdown-item text-center text-secondary" href="#"> <span class="text-capitalize"><?php echo $_SESSION['member']['nama_lengkap']; ?></span></a>
    ...
    <div class="mt-5 p-4">
      ...
      ?>
        ...
        <div class="alert alert-success" role="alert" style="background-color: hotpink; border: hotpink">
            Selamat datang member -
            <span class="text-capitalize fw-bold">
        <?php
        if(isset($_SESSION['member']['nama_lengkap'])) {
            echo htmlspecialchars($_SESSION['member']['nama_lengkap']);
        } else {
            echo "Perpustakaan"; // Atau pesan default lainnya
        }
        ?>
    </span> di Dashboard KeyLibrary
        </div>
       ...
       <h3 class="mb-3">Layanan Perpustakaan yang tersedia</h3>
        ...
        <div class="cardImg">
          <a href="buku/daftarBuku.php">
            <img src="../assets/dashboardCardMember/bukuMember.png" alt="daftar buku" style="max-width: 100%;" width="600px">
          </a>
        </div>
        <div class="cardImg">
          <a href="formPeminjaman/TransaksiPeminjaman.php">
          <img src="../assets/dashboardCardMember/peminjamanMember.png" alt="peminjaman" style="max-width: 100%;" width="600px">
          </a>
        </div>

        <div class="cardImg">
          <a href="formPeminjaman/TransaksiPengembalian.php">
            <img src="../assets/dashboardCardMember/pengembalianMember.png" alt="pengembalian" style="max-width: 100%;" width="600px" height="300px">
          </a>
        </div>
        <div class="cardImg">
          <a href="formPeminjaman/TransaksiDenda.php">
          <img src="../assets/dashboardCardMember/denda.png" alt="daftar buku" style="max-width: 100%;" width="650px" height="300px">
          </a>
        </div>
       </div>
     ...
     <footer class="shadow-lg bg-subtle p-3" style="background-color: whitesmoke">
         <div class="container-fluid d-flex justify-content-between">
             ...
             <p class="mt-2">Teknik Informatika 2022
             </p>
         </div>
     </footer>
