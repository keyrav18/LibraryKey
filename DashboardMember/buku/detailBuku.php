...
<html lang="en">
  ...
  <?php endforeach; ?>
  <div class="card-body">
    <a href="daftarBuku.php" class="btn btn-danger" style="background-color: blue; border: none">Batal</a>
     <a href="../formPeminjaman/pinjamBuku.php?id=<?= $item["id_buku"]; ?>" class="btn btn-success" style="background-color: deeppink; border: none">Pinjam</a>
     </div>
    </div>
   </div>
  </div>
