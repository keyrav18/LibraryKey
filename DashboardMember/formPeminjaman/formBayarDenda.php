...
$dendaSiswa = $_GET["id"];
$query = queryReadData("SELECT pengembalian.id_pengembalian, buku.judul, member.nama_lengkap, pengembalian.buku_kembali, pengembalian.keterlambatan, pengembalian.denda
FROM pengembalian
  ...
  <div class="p-4 mt-5">
    ...
    <h3>Form bayar denda</h3>
      ...
      <div class="mt-4 mb-3">
          ...
          <input type="text" class="form-control" placeholder="Nama siswa" name="nama" id="nama" value="<?= $item["nama_lengkap"]; ?>" readonly>
          </div>
