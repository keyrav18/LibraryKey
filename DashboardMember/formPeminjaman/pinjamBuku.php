            ...
            <form action="" method="post">
                <?php foreach ($dataSiswa as $item) : ?>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="nama" aria-label="nama" aria-describedby="basic-addon1" value="<?= $item["nama_lengkap"]; ?>" readonly>
                    </div>
                    <div class="input-group mb-3">
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <form action="" method="post">
                ...
                <a class="btn btn-danger" href="../buku/daftarBuku.php" style="background-color: blue; border: blue"> Batal</a>
                <button type="submit" class="btn btn-success" name="pinjam" style="background-color: deeppink; border: none">Pinjam</button>
            </form>
        </div>
    </div>
