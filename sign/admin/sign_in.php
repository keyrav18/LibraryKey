...
<html lang="en">
  ...
  <div class="container">
    <div class="card p-2 mt-5">
      <div class="position-absolute top-0 start-50 translate-middle">
        <img src="../../assets/adminLogo.png" class="" alt="adminLogo" width="100px">
      </div>
  ...
  <div class="col-12">
    <button class="btn btn-primary" style="background-color: deeppink; border: deeppink" type="submit" name="signIn">Sign In</button>
    <a class="btn btn-success" style="background-color: blue" href="../link_login.html">Batal</a>
  </div>
</form>
</div>
<?php if(isset($error)) : ?>
