  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-success" href="daftarBuku.php" style="color: black">Cari Buku</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="container p-3 mt-5" style="background-color: antiquewhite">
      <div class="card p-2 mt-5">
            <img src="../../assets/book.png" alt="logo buku" height="80px" width="80px" style="margin: auto;">
            <h1 class="fw-bold p-3 text-center">Form Tambah Buku</h1>
      ...
      <button class="btn btn-success" type="submit" name="tambah"style="background-color: deeppink; border: deeppink">Tambah</button>
      <input type="reset" class="btn btn-warning text-light" value="Reset" style="background-color: blue">
      </form>
    </div>
  </div>
    
  <footer class="mt-5 shadow-lg bg-subtle p-3" style="background-color: whitesmoke">
      <div class="container-fluid d-flex justify-content-between">
      <p class="mt-2">Created by <span class="text-primary"> Kayla Nazelika</span> © 2022</p>
      <p class="mt-2">Tehnik Informatika 2022</p>
      </div>
    </footer>
