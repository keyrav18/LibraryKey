...
<div class="p-4 mt-4" style="background-color: antiquewhite">
      <!--search engine --->
     <form action="" method="post" class="mt-5">
       ...
       <!--Card buku-->
       <div class="layout-card-custom" style="background-color: antiquewhite">
       ...
       <div class="card" style="width: 15rem;">
        ...
        <div class="card-body">
          <a class="btn btn-success" href="updateBuku.php?idReview=<?= $item["id_buku"]; ?>" id="review" style="background-color: deeppink; border: deeppink" >Edit</a>
          
          <a class="btn btn-danger" href="deleteBuku.php?id=<?= $item["id_buku"]; ?>" onclick="return confirm('Yakin ingin menghapus data buku ? ');" style="background-color: blue; border: none">Delete</a>
          </div>
        </div>
       <?php endforeach; ?>
       </div>
