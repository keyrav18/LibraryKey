  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-success" href="daftarBuku.php">Cari Buku</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="container p-3 mt-5" style="background-color: antiquewhite">
      <div class="card p-2 mt-5" >
          <img src="../../assets/updatebook.png" alt="logo update book" width="70px" height="70px" style="margin: auto">
      ...
      <button class="btn btn-success" type="submit" name="update" style=" background-color: deeppink; border: none">Edit</button>
      <a class="btn btn-danger" href="daftarBuku.php" style="background-color: blue;border: none">Batal</a>
      </form>
    </div>
  </div>
