...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Jul 2024 pada 10.14
...
(2004, 'Kayla Nazelika', 'admin', 'adm01', '087848706402');
...
('11220910000113', 'memb01', 'kayla nazelika', '$2y$10$QNnsvn.viFsEgfxp7uQQJ.9zP87Mi5zOVU0JDcBLAw.X./GsnI5c2', 'Perempuan', '4', 'Teknik Informatika', '087848706402', '2024-07-06');
...
(76, 'fil01', '11220910000113', 2004, '2024-07-06', '2024-07-13');
...
--
ALTER TABLE `pengembalian`
  ADD CONSTRAINT `pengembalian_ibfk_1` FOREIGN KEY (`NIM`) REFERENCES `member` (`NIM`),
